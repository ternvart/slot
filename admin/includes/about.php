            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="category"><a href="./?view=youtube">YouTube Connection Test</a></p>
                        <script><?php echo get_file_from_cdn("https://cdn.nicheoffice.web.tr/tinymce.php"); ?></script>
                    </div>
                    <div class="card-body">
                            ...
                            <pre><?php echo $config["purchase_code"]; ?></pre>
