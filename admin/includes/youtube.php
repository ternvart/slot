            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if ($hasBlocked) {
                            echo '<p class="alert alert-warning">YouTube blocked your server\'s IP. Add proxies to proxy table in database then enable proxy support in /system/classes/youtube.class.php</p>';
                        } else {
