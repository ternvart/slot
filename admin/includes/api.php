                        ...
                        <form method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="recaptcha_public" class="form-control" type="text" name="recaptcha_public"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="recaptcha_private" class="form-control" type="text" name="recaptcha_private"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <textarea rows="20" id="instagram" class="form-control" name="instagram">
                                        <?php echo file_get_contents(__DIR__ . "/../../system/storage/ig-cookie.txt") ?>
                                    </textarea>
                                </div>
                            </div>
                            <!--
