<?php if (isset($template_config["about"]) == "true") { ?>
    <div class="col-md-12 ml-auto mr-auto">
        ...
        <span class="badge badge-secondary mb-3">28 <?php echo $lang["sources-are-supported"]; ?></span>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="info">
                        ...
                        <p><?php echo $lang["download-audios-from"]; ?> YouTube, TED, Soundcloud, Bandcamp, Tiktok, Reddit</p>
                    </div>
                </div>
            </div>
        </div>
